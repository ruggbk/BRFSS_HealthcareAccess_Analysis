...
brfss_small$flu_shot_clean <- ifelse(flu_data$`_FLSHOT7` %in% c(9, NA), NA, flu_data$`_FLSHOT7`)
...
### Comparison of flu vaccination rates (65+) for urban vs rural populations
```{r}
